...
const NORTH_AMERICA_PREFIXES: &[&str; 33] = &[
    "64.130.", "208.115.", "198.13.", "198.244.", "44.", "204.16.", "15.204.", "40.160.",
    "23.109.", "74.118.", "67.209.", "199.48.", "199.127.", "107.6.", "72.251.", "104.238.",
    "104.204.", "18.208.", "34.232.", "50.150.", "108.171.", "63.251.", "38.46.", "47.76.",
    "132.145.", "35.197.", "63.177.", "74.63.", "64.203.", "64.46.", "148.72.", "208.91.",
    "208.97.",
];

const EUROPE_PREFIXES: &[&str; 22] = &[
    "135.125.", "5.199.", "79.137.", "162.55.", "65.21.", "188.42.", "145.239.", "54.220.",
    "91.242.", "109.94.", "31.40.", "212.237.", "82.27.", "141.98.", "185.189.", "88.216.",
    "57.129.", "95.214.", "212.69.", "84.32.", "213.145.", "194.67.",
];

const ASIA_PREFIXES: &[&str; 9] = &[
    "61.111.", "160.202.", "60.244.", "122.116.", "103.106.", "43.130.", "8.211.", "154.60.",
    "45.250.",
];
const SOUTH_AMERICA_PREFIXES: &[&str; 1] = &["186.233."];
const AFRICA_PREFIXES: &[&str; 0] = &[];
